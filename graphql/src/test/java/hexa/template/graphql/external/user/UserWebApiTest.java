...
public class UserWebApiTest extends BaseRestClientTest {
    ...
    class GetUser {
        ...
        void shouldReturnUser() {
            ...
            final var userDto = userWebApi.getUser(1L).block();
    ...
    class CreateUser {
        ...
        void shouldCreateUser() {
            ...
            final var createdUser = userWebApi.createUser(USER).block();
        ...
        void shouldUseBasicAuth() {
            ...
            userWebApi.createUser(USER).block();
    ...
    class UpdateUser {
        ...
        void shouldUpdateUser() {
            ...
            final var updatedUser = userWebApi.updateUser(1L, USER).block();
        ...
        void shouldUseBasicAuth() {
            ...
            userWebApi.updateUser(1L, USER).block();
    ...
    class DeleteUser {
        ...
        void shouldDeleteWithBasicAuth() {
            ...
            userWebApi.deleteUser(1L).block();
